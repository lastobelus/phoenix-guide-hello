defmodule Hello.ExampleServer do
  @moduledoc """
  An example GenSerer that runs arbitrary functions and emits telemetry events when called
  """

  use GenServer

  # A common prefix for :telemetry events
  @prefix [:hello, :example_server, :call]
  ...
  @doc """
    ...
    * `[:hello, :example_server, :call, :start]` — Dispatched
    ...
    * `[:hello, :example_server, :call, :stop]` — Dispatched
    ...
    * `[:hello, :example_server, :call, :exception]` — Dispatched
